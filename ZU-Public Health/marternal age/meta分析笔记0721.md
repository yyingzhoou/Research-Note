...
### 1） 检索数据库的选择
对于医学类的meta分析，我们主要检索[Medline](https://melineskin.com/en/)(via [PubMed](https://pubmed.ncbi.nlm.nih.gov/))、[Embase](https://www.embase.com/)、[Cochrane library](https://www.cochranelibrary.com/)三个数据库。
- Medline包含了约有4800种生物医学期刊，内容涉及医学、护理、健康保健等多个学科，其收录以北美文献为主。支持主题词检索、字段限定检索、截词检索和自由词检索，需要检索人员根据需要人工选定合适的检索方式进行检索。
- PubMed不仅具有MEDLINE的检索方式，还可以执行自动匹配（Automatic Term Mapping，ATM）。
...
- [PsycINFO   databases](https://www.apa.org/pubs/databases/psycinfo) 
- [Google Scholar](https://scholar.google.com.hk/?hl=en)
